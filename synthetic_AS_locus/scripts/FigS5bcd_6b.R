...
fcs_dir <- "../data/fcs_files_FigS5_2i/"
output_dir <- "../figures/"
...
grid.arrange(fix)
ggsave("FigS5b.pdf", fix, width = 10, height = 15, units = "cm", dpi = 300,useDingbats=FALSE)
...
fix <- set_panel_size(hist_plot, height = unit(2, "cm"), width = unit(1.5, "cm"))
grid.arrange(fix)
ggsave("FigS5c.pdf", fix, width = 10, height = 15, units = "cm", dpi = 300,useDingbats=FALSE)
...
fix <- set_panel_size(hist_plot, height = unit(2, "cm"), width = unit(1.5, "cm"))
grid.arrange(fix)
ggsave("FigS5d.pdf", fix, width = 10, height = 15, units = "cm", dpi = 300,useDingbats=FALSE)
...
ggsave("Fig6b.pdf", fix, dpi = 300,useDingbats=FALSE)
