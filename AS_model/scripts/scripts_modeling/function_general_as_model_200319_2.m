function [] = function_general_as_model_200319_2(inputFilename,outputFilename)
...
for loop=1:size(par,1)
	% kinetic rates
	%k(1): Binding rate of Pol to A, k(2):Binding rate of Pol to B, k(3): Deg RNA A, k(4): Deg RNA B, k(5):average time of pA in OFF state, k(6): average time of pB in OFF state, 
	%k7: Production rate of protein A, k8: Production rate of protein B, k9: Deg rate protein A, k10: Deg rate protein B, k11: rate of release or termination of RNAPs from pA,
	%k12: rate of release or termination of RNAPs from pB, k13: probability for pA bound RNAP to terminate, k14: probability for pB bound RNAP to terminate
	k = par(loop, 1:20);
	...
	for alleles = 1:nr_alleles
		...
		[t1,ap1,bp1,ar1,br1,apr1,bpr1,pAo1,pBo1] = reaction_general_AS_model_200319_2(k, p, const_par, ...
		A_pol, B_pol, A_RNA, B_RNA, A_Pr, B_Pr, pA, pB);
		...
		const_par = [t_start, t_max, output_time_step, overlap, dima_prior, dimb_prior, dima_post, dimb_post];		
		[t2,ap2,bp2,ar2,br2,apr2,bpr2,pAo2,pBo2] = reaction_general_AS_model_200319_2(k, p, const_par, ...
		A_pol, B_pol, A_RNA, B_RNA, A_Pr, B_Pr, pA, pB);
