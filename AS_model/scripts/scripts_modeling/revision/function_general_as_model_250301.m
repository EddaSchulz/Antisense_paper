function [] = function_general_as_model_250301(inputFilename,outputFilename)
...
for loop=1:size(par,1)
	...
	for alleles = 1:nr_alleles
		...
		[t1,ap1,bp1,ar1,br1,apr1,bpr1,pAo1,pBo1] = reaction_general_AS_model_250301(k, p, const_par, ...
		...
		const_par = [t_start, t_max, output_time_step, overlap, dima_prior, dimb_prior, dima_post, dimb_post];		
		[t2,ap2,bp2,ar2,br2,apr2,bpr2,pAo2,pBo2] = reaction_general_AS_model_250301(k, p, const_par, ...
		A_pol, B_pol, A_RNA, B_RNA, A_Pr, B_Pr, pA_AS, pB_AS, pA_b, pB_b);
