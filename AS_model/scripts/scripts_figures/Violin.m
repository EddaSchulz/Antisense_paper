...
classdef Violin < handle
    ...
    methods
        function obj = Violin(data, pos, varargin)
            ...
            switch args.DataStyle
                case 'scatter'
                    if ~isempty(data2)
                        ...
                        %obj.ScatterPlot_a = ...
                        %    scatter(pos(data>100) + jitter(data>100).*jitterstrength(data>100), data(data>100), args.MarkerSize, 'filled');
           ...
           % Modified VM
           %obj.MeanPlot.Color = [217,95,2]./255;
           %obj.MeanPlot.MarkerFaceColor =[217,95,2]./255;
           %obj.MeanPlot.MarkerEdgeColor =[217,95,2]./255;
